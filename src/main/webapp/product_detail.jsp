...
<ul>
  ...
  <li><a href="product1"><i class="fa fa-shopping-bag"></i>Products</a></li>
 ...
 <div class="container-xl">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/36.jpg" class="d-block w-100" alt="abc">
   ...
   <div class="col-md-7">
     <div class="detail_1r">
	  ...
	  <h4 class="mt-3"><span class="me-2">₹15000.00</span> <span class="fs-6 text-decoration-line-through col_light">$28.00</span></h4>
	  ...
	  <h6 class="mt-4 mb-0 text-uppercase"><a class="button" href="cuslogin"><i class="fa fa-shopping-cart bg-white col_pink p-3"> </i> <span class="ps-3 pe-3">Add To Cart</span></a></h6>
  ...
  <div class="row detail_3 mt-4">
   <div class="tab-content">
    ...
    <div class="tab-pane" id="profile">
		...
		<div class="col-lg-1 col-md-2 col-2">
		<div class="profilei1l">
		<img src="image/4.jpg" class="w-100" alt="abc">
		</div>
		</div>
		<div class="col-lg-11 col-md-10 ps-0 col-10">
		<div class="profilei1r p-3">
        ...
        <div class="product_2imi clearfix">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/5.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
     ...
     <div class="prod_main p-1 bg-white clearfix">
	   <div class="product_2im clearfix position-relative">
        <div class="product_2imi clearfix">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/6.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
		<div class="product_2imi1 position-absolute clearfix w-100 top-0 text-center">
     ...
     <div class="prod_main p-1 bg-white clearfix">
	   <div class="product_2im clearfix position-relative">
        <div class="product_2imi clearfix">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/42.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
		<div class="product_2imi1 position-absolute clearfix w-100 top-0 text-center">
     ...
     <div class="prod_main p-1 bg-white clearfix">
	   <div class="product_2im clearfix position-relative">
        <div class="product_2imi clearfix">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/11.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
		<div class="product_2imi1 position-absolute clearfix w-100 top-0 text-center">
...
<section id="footer" class="pt-3 pb-3">
 <div class="container-fluid">
	 ...
	 <p class="mb-0">© 2013 Your Website Name. All Rights Reserved | Design by <a class="col_pink" href="http://127.0.0.1:5500/painting_zip/index.html">OUR TEAM</a></p>
