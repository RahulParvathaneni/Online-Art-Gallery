		 ...
		 <div class="blog_1ril1 clearfix">
		   <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/3.jpg" height="480" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		 </div>
	   ...
	   <div class="blog_1dt4i row">
	    <div class="col-md-1 col-1 pe-0">
		 <div class="blog_1dt4il">
		  <img src="image/56.jpg" class="w-100 rounded-circle" alt="abc">
		 </div>
		</div>
...
<h6 class="font_14 mb-0 mt-3"><a class="button p-3 pt-2 pb-2" href="#">Reply</a></h6>
	   ...
	   <div class="blog_1dt4i row">
	    <div class="col-md-1 pe-0 col-1">
		 <div class="blog_1dt4il">
		  <img src="image/55.jpg" class="w-100 rounded-circle" alt="abc">
		 </div>
		</div>
		<div class="col-md-11 col-11">
		 <div class="blog_1dt4ir">
...
<h6 class="font_14 mb-0 mt-3"><a class="button p-3 pt-2 pb-2" href="#">Reply</a></h6>
	   ...
	   <div class="blog_1dt4i row">
	    <div class="col-md-1 pe-0 col-1">
		 <div class="blog_1dt4il">
		  <img src="image/57.jpg" class="w-100 rounded-circle" alt="abc">
		 </div>
		</div>
		<div class="col-md-11 col-11">
		 <div class="blog_1dt4ir">
	  ...
	  <div class="footer_1i1 row">
	   <div class="col-md-4 col-4 p-0">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/8.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	   <div class="col-md-4 col-4 p-0">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/9.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	  ...
	  <div class="footer_1i1 row">
	   ...
	   <div class="col-md-4 col-4 p-0">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/4.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
	   <div class="col-md-4 col-4 p-0">
	    <div class="footer_1i1i">
		  <div class="grid clearfix">
				  <figure class="effect-jazz mb-0">
					<a href="#"><img src="image/2.jpg" class="w-100" alt="abc"></a>
				  </figure>
			  </div>
		</div>
	   </div>
